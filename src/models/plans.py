...
class PlansModel(db.Model):
    ...
    product_id = db.Column(db.String(256), db.ForeignKey('products.id', ondelete='CASCADE'))
    ...
    product = db.relationship(ProductsModel, foreign_keys=product_id, cascade="all,delete")
